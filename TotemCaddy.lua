...
TOCA.Call:SetPoint("CENTER", 0, 47)
...
--[==[
TOCA.Call:SetScript("OnClick", function()
  print("test")
end)
]==]--
...
TOCA.CallFlash:Hide()
TOCA.Call.highlight= TOCA.Call:CreateTexture(nil, "ARTWORK", TOCA.Call, 0)
TOCA.Call.highlight:SetSize(TOCA.Call_w, TOCA.Call_h)
TOCA.Call.highlight:SetPoint("CENTER", 0, 0)
TOCA.Call.highlight:SetTexture("Interface/Buttons/ButtonHilight-Square")
TOCA.Call.highlight:SetBlendMode("ADD")
TOCA.Call.highlight:Hide()
...
TOCA.FrameMainExt:SetPoint("CENTER", TOCA.Global.width-34, 0)
...
TOCA.Button.OpenFrameMainExt:SetSize(22, 22)
TOCA.Button.OpenFrameMainExt:SetPoint("CENTER", 74, -31)
TOCA.Button.OpenFrameMainExt:SetBackdrop({
  bgFile  = "Interface/GuildBankFrame/UI-GuildBankFrame-NewTab",
  edgeFile= "Interface/ToolTips/UI-Tooltip-Border",
  edgeSize= 12,
  insets  = {left=2, right=2, top=2, bottom=2},
})
...
TOCA.Button.CloseMain:SetSize(18, 18)
...
TOCA.Dropdown.Main:SetPoint("TOPLEFT", -6, -68)
...
UIDropDownMenu_SetWidth(TOCA.Dropdown.Main, 124)
