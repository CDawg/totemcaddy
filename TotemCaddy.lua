...
for i=1, 4 do
  ...
  TOCA.SlotGrid.VerticalTimer[i]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
  ...
  TOCA.SlotGrid.HorizontalTimer[i]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
  ...
  if (totemCat == "AIR") then
    if (TOCA.isInCombat) then
      ...
      TOCA.Slot.Timer[4]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
  ...
  if (totemCat == "EARTH") then
    if (TOCA.isInCombat) then
      ...
      TOCA.Slot.Timer[2]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
  ...
  if (totemCat == "FIRE") then
    if (TOCA.isInCombat) then
      ...
      TOCA.Slot.Timer[1]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
  ...
  if (totemCat == "WATER") then
    if (TOCA.isInCombat) then
      ...
      TOCA.Slot.Timer[3]:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
  ...
  for i,totemSpell in pairs(TOCA.totems[totemCat]) do
    ...
    TOCA.SlotGrid.VerticalTotemButton[totemCat][i].action:RegisterForClicks("AnyDown", "AnyUp")
    ...
    TOCA.SlotGrid.HorizontalTotemButton[totemCat][i].action:RegisterForClicks("AnyDown", "AnyUp")
...
TOCA.FrameMain.ShieldFrame.timer:SetFont(TOCA._G.font.style, TOCA._G.font.size-2)
...
TOCA.FrameMain.ShieldFrame.count:SetFont(TOCA._G.font.style, TOCA._G.font.size-1, "OUTLINE")
...
TOCA.FrameMain.ReincFrame.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-2)
...
TOCA.FrameMain.AnkhFrame.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Button.DropdownMain.icon:SetSize(18, 14)
TOCA.Button.DropdownMain.icon:SetPoint("RIGHT", -2, -3)
...
TOCA.Button.DropdownMain.text = TOCA.Button.DropdownMain:CreateFontString(nil, "ARTWORK")
TOCA.Button.DropdownMain.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
--TOCA.Button.DropdownMain.text:SetPoint("TOPLEFT", TOCA.Button.DropdownMain, "TOPLEFT", 25, -8)
TOCA.Button.DropdownMain.text:SetPoint("TOPLEFT", TOCA.Button.DropdownMain, "TOPLEFT", 4, -2)
TOCA.Button.DropdownMain.text:SetText(TOCA.Dropdown.Menu[1])
...
TOCA.Dropdown.Main.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Dropdown.Main.onClick = function(self, checked)
  ...
  TOCA.Button.DropdownMain.text:SetText(string.sub(self.value, 0, 18))
end
