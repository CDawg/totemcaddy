...
TOCA.Button.Options:SetScript("OnEnter", function(self)
  ...
  TOCA.TooltipDisplay(self, TOCA.Global.title, "v" .. TOCA.Global.version .. "-" .. TOCA.Global.suffix .. " ("..GetLocale()..")")
end)
...
TOCA.FrameMain.AnkhFrame.text:SetFont(TOCA.Global.font, 12, "OUTLINE")
