...
TOCA.Checkbox.FrameWeap.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.FrameWeap.flip.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
