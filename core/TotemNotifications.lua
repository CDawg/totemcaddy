...
TOCA.FrameOptions.Title.Notifs:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Checkbox.NotifyCombat.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.ExpireMessage.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.ExpireSound.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Dropdown.Sound.TotemExpire.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Dropdown.Sound.TotemExpire.onClick = function(self, checked)
  ...
  TOCADB[TOCA.player.combine]["CONFIG"]["SOUNDFILE"] = self.value
	PlaySoundFile(TOCA._G.path .. "sounds/" .. self.value .. ".ogg")
end
...
TOCA.Checkbox.ShieldMessage.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.ShieldExpire.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Dropdown.Sound.ShieldExpire.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Checkbox.TotemRadiusVisual.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
