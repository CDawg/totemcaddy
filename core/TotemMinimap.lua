...
for i=1, 4 do
	...
	TOCA.TotemRadius[i].radius:SetTexture(TOCA._G.path .. "images/radius.tga")
	...
	TOCA.TotemRadius[i].ring = TOCA.TotemRadius[i]:CreateTexture(nil, "ARTWORK")
	TOCA.TotemRadius[i].ring:SetSize(TOCA.TotemRadius[i]:GetWidth(), TOCA.TotemRadius[i]:GetHeight())
	TOCA.TotemRadius[i].ring:SetPoint("CENTER", 0, 0)
	TOCA.TotemRadius[i].ring:SetTexture(TOCA._G.path .. "images/radius_ring.tga")
	TOCA.TotemRadius[i].ring:SetBlendMode("BLEND")
	TOCA.TotemRadius[i].ring:SetVertexColor(0, 1, 0, TOCA.TotemRadiusAlpha) --default a green just in case
	...
	TOCA.TotemRadius[i].ring:SetVertexColor(TOCA.TotemRadius[i].radius:GetVertexColor())
			...
			totem:SetScript("OnUpdate", function(self, lapse)
				...
				if (totem) then
					...
					if (not inInstance) then
						...
						self.ring:SetSize(self.radius:GetSize())
						--print("icms " .. iconMaxSize)

						self.radius:SetTexture(TOCA._G.path .. "images/radius.tga")
						self.ring:SetTexture(TOCA._G.path .. "images/radius_ring.tga")
						if (TOCADB[TOCA.player.combine]["CONFIG"]["MINIMAP_TOTEM_RINGS"] == "OFF") then
							self.ring:SetTexture("")
						end

						if (TOCADB[TOCA.player.combine]["CONFIG"]["MINIMAP_TOTEM_SOLID"] == "OFF") then
							self.radius:SetTexture("")
						end
...
--[==[
local MMIcon = TOCA._G.path .. "images/totem_icon_minimap.tga"
...
TOCA.FrameOptions.Title.Minimap:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Checkbox.MinimapButton.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MinimapButton.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MinimapButton.text:SetText(TOCA._L.UI.MINIMAP[1][1])
TOCA.Checkbox.MinimapButton:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.MINIMAP[1][2])
end)
...
TOCA.Button.MinimapResetText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
TOCA.Button.MinimapResetText:SetPoint("CENTER", 0, 0)
TOCA.Button.MinimapResetText:SetText(TOCA._L.UI.OPTIONS[5][1])
...
TOCA.Checkbox.MinimapTotems.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MinimapTotems.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MinimapTotems.text:SetText(TOCA._L.UI.MINIMAP[2][1])
TOCA.Checkbox.MinimapTotems:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.MINIMAP[2][2])
end)
...
TOCA.Checkbox.MinimapTotems:SetScript("OnClick", function(self)
  if (self:GetChecked()) then
    TOCADB[TOCA.player.combine]["CONFIG"]["MINIMAP_TOTEMS"] = "ON"
		...
		TOCA.Checkbox.MinimapTotemSolid:SetAlpha(1)
...
TOCA.Checkbox.MinimapTotemSolid.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MinimapTotemSolid.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MinimapTotemSolid.text:SetText(TOCA._L.UI.MINIMAP[3][1])
TOCA.Checkbox.MinimapTotemSolid:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.MINIMAP[3][2])
end)
TOCA.Checkbox.MinimapTotemSolid:SetScript("OnLeave", function(self)
  TOCA.CloseAllMenus()
end)
TOCA.Checkbox.MinimapTotemSolid:SetScript("OnClick", function(self)
  if (self:GetChecked()) then
    TOCADB[TOCA.player.combine]["CONFIG"]["MINIMAP_TOTEM_SOLID"] = "ON"
  else
    TOCADB[TOCA.player.combine]["CONFIG"]["MINIMAP_TOTEM_SOLID"] = "OFF"
  end
end)
...
TOCA.Checkbox.MinimapTotemRings.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MinimapTotemRings.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MinimapTotemRings.text:SetText(TOCA._L.UI.MINIMAP[4][1])
TOCA.Checkbox.MinimapTotemRings:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.MINIMAP[4][2])
end)
...
TOCA.Checkbox.MinimapTotemIcons.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MinimapTotemIcons.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MinimapTotemIcons.text:SetText(TOCA._L.UI.MINIMAP[5][1])
TOCA.Checkbox.MinimapTotemIcons:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.MINIMAP[5][2])
end)
