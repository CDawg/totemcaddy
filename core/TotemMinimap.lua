...
for i=1, 4 do
	...
	TOCA.TotemRadius[i].radius:SetTexture(TOCA._G.dir .. "images/radius.tga")
	...
	TOCA.TotemRadius[i].ring:SetTexture(TOCA._G.dir .. "images/radius_ring.tga")
			...
			totem:SetScript("OnUpdate", function(self, lapse)
				...
				if (totem) then
					...
					if (not inInstance) then
						...
						self.radius:SetTexture(TOCA._G.dir .. "images/radius.tga")
						self.ring:SetTexture(TOCA._G.dir .. "images/radius_ring.tga")
...
TOCA.Checkbox.MinimapButton.text:SetFont(TOCA._G.font, 12, "OUTLINE")
...
TOCA.Button.MinimapResetText:SetFont(TOCA._G.font, 11)
...
TOCA.Checkbox.MinimapTotems.text:SetFont(TOCA._G.font, 12, "OUTLINE")
...
TOCA.Checkbox.MinimapTotemSolid.text:SetFont(TOCA._G.font, 12, "OUTLINE")
...
TOCA.Checkbox.MinimapTotemRings.text:SetFont(TOCA._G.font, 12, "OUTLINE")
...
TOCA.Checkbox.MinimapTotemIcons.text:SetFont(TOCA._G.font, 12, "OUTLINE")
