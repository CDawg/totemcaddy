...
for totemCat,v in pairsByKeys(TOCA.totems) do
	...
	for i,totemSpell in pairs(TOCA.totems[totemCat]) do
	  ...
	  TOCA.FrameSeg.Button[totemCat][i]:SetSize(TOCA.Slot_w, TOCA.Slot_h)
		...
		TOCA.FrameSeg.Button[totemCat][i].highlight = TOCA.FrameSeg.Button[totemCat][i]:CreateTexture(nil, "ARTWORK", TOCA.FrameSeg.Button[totemCat][i], 0)
		...
		TOCA.FrameSeg.Button[totemCat][i].radius = TOCA.FrameSeg.Button[totemCat][i]:CreateTexture(nil, "ARTWORK", TOCA.FrameSeg.Button[totemCat][i], 1)
