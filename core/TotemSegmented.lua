...
for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
	...
	for i,totemSpell in pairs(TOCA.totems[totemCat]) do
	  ...
	  TOCA.FrameSeg.Button[totemCat][i]:SetSize(TOCA.Slot_w, TOCA.Slot_h)
		...
		TOCA.FrameSeg.Button[totemCat][i].ID:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
		...
		TOCA.FrameSeg.Button[totemCat][i].timer:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
