...
TOCA.OptionsPosition_x["LEFT"]=30
...
TOCA.Button.ResetPositionText:SetText(TOCA.locale.UI.OPTIONS[5][1])
...
TOCA.FrameOptions.Title.OpacityBG:SetText(TOCA.locale.UI.OPTIONS[6][1])
...
TOCA.Button.ResetOpacityBG:SetScript("OnEnter", function(self)
  self:SetBackdropBorderColor(1, 1, 0.8, 1)
  TOCA.TooltipDisplay(self, TOCA.locale.UI.OPTIONS[7][1], TOCA.locale.UI.OPTIONS[7][2])
end)
...
TOCA.FrameOptions.Title.OpacityFG:SetText(TOCA.locale.UI.OPTIONS[8][1])
...
TOCA.Slider.OpacityFG:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, TOCA.FrameOptions.Title.OpacityFG:GetText(), TOCA.locale.UI.OPTIONS[8][2])
end)
...
TOCA.Button.ResetOpacityFG:SetScript("OnEnter", function(self)
  self:SetBackdropBorderColor(1, 1, 0.8, 1)
  TOCA.TooltipDisplay(self, TOCA.locale.UI.OPTIONS[9][1], TOCA.locale.UI.OPTIONS[9][2])
end)
...
TOCA.FrameOptions.Title.Menu:SetText(TOCA.locale.UI.FRAME.TITLE)
...
TOCA.Checkbox.MainLock.text:SetText(TOCA.locale.UI.FRAME[1][1])
TOCA.Checkbox.MainLock:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.FRAME[1][2])
end)
...
TOCA.Checkbox.MainMenu:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.FRAME[2][2])
end)
...
TOCA.Checkbox.FrameBorder.text:SetText(TOCA.locale.UI.FRAME[3][1])
...
TOCA.Checkbox.FrameBorder:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.FRAME[3][2])
end)
...
TOCA.Checkbox.Totemic.text:SetText(TOCA.locale.UI.FRAME[4][1])
...
TOCA.Checkbox.Totemic:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.FRAME[4][2])
end)
...
TOCA.Checkbox.EndCaps.text:SetText(TOCA.locale.UI.FRAME[5][1])
...
TOCA.Checkbox.EndCaps:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.FRAME[5][2])
end)
...
TOCA.Checkbox.Timers.text:SetText(TOCA.locale.UI.TIMERS[1][1])
...
TOCA.Checkbox.Timers:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.TIMERS[1][2])
end)
...
TOCA.Checkbox.TimersInMinutes.text:SetText(TOCA.locale.UI.TIMERS[2][1])
...
TOCA.Checkbox.TimersInMinutes:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.TIMERS[2][2])
end)
...
TOCA.Checkbox.Reinc.text:SetText(TOCA.locale.UI.TIMERS[3][1])
...
TOCA.Checkbox.Reinc:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.TIMERS[3][2])
end)
...
TOCA.Checkbox.Tooltip.text:SetText(TOCA.locale.UI.TOOLTIP[1][1])
...
TOCA.Checkbox.Tooltip:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA.locale.UI.TOOLTIP[1][2])
end)
