...
TOCA.SliderBackdrop(TOCA.Slider.Scale)
...
TOCA.SliderBackdrop(TOCA.Slider.OpacityBG)
...
TOCA.SliderBackdrop(TOCA.Slider.OpacityFG)
...
TOCA.Checkbox.MainMenuOpt.text:SetFont(TOCA._G.font, 12, "OUTLINE")
