...
TOCA.Dropdown.FrameStrat:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay("Frame Layer", "Sets the overlap over other menu and action bar items|non your screen.|nHigher frames will take precedence over items on screen.", 120)
end)
...
TOCA.Button.ResetScale:SetScript("OnEnter", function(self)
  ...
  TOCA.TooltipDisplay("Reset Scale", "Reset the frame scale to the default size.", 80)
end)
...
TOCA.Button.ResetOpacityBG:SetScript("OnEnter", function(self)
  self:SetBackdropBorderColor(1, 1, 0.8, 1)
  TOCA.TooltipDisplay("Reset Background Opacity", "Reset the background opacity to the default value.", 80)
end)
...
TOCA.FrameOptions.Title.OpacityFG:SetPoint("TOPLEFT", 30, -280)
...
TOCA.Slider.OpacityFG:SetMinMaxValues(0.00, 1.0)
...
TOCA.Button.ResetOpacityFG:SetScript("OnEnter", function(self)
  self:SetBackdropBorderColor(1, 1, 0.8, 1)
  TOCA.TooltipDisplay("Reset Foreground Opacity", "Reset the foreground opacity to the default value.", 80)
end)
...
TOCA.FrameOptions.Title.Timer:SetPoint("TOPLEFT", 400, -140)
...
TOCA.Checkbox.Ankh:SetPoint("TOPLEFT", 400, -220)
...
TOCA.FrameOptions.Title.Tooltip:SetPoint("TOPLEFT", 400, -260)
...
TOCA.Checkbox.Tooltip:SetPoint("TOPLEFT", 400, -280)
