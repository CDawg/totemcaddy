...
TOCA.Dropdown.FrameStyle:SetScript("OnEnter", function()
  TOCA.TooltipMenu("Frame Style", "|cffffffffClassic|r\nFour primary totems that are commonly used|nselectable or profile built.|n|n|cffffffffGrid Vertical|r|nAll known Totems are displayed vertically organized|nby category row.|n|n|cffffffffGrid Horizontally|r|nAll known Totems are displayed Horizontally organized|nby category row.|n|nThe totem category orders are configurable|nin the options menu.", 230)
end)
