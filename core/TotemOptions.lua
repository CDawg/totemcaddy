...
TOCA.Dropdown.FrameStrat:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, TOCA.Dropdown.FrameStrat.title:GetText(), "Sets the overlap over other menu and action bar items|non your screen.|nHigher frames will take precedence over items on screen.")
end)
