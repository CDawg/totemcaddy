...
for i=1, getn(TOCA._L.UI.TABS.OPTIONS) do
  ...
  TOCA.Button.TabOptions[i].text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
  ...
  TOCA.Button.TabOptions[i]:SetScript("OnClick", function()
    for i=1, getn(TOCA._L.UI.TABS.OPTIONS) do
      ...
      TOCA.Button.TabOptionsBack[i]:SetSize(TOCA.TabWidth.Options-20, 29)
        ...
        Settings.OpenToCategory(Settings.KEYBINDINGS_CATEGORY_ID, TOCA.Category) --bindings.xml
...
TOCA.Dropdown.FrameStyle.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Dropdown.FrameStyle.title:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Dropdown.FrameStrat.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Dropdown.FrameStrat.title:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.FrameOptions.Title.Scale:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Slider.Scale.Val:SetFont(TOCA._G.font.style, TOCA._G.font.size-1, "OUTLINE")
...
TOCA.Slider.Scale:SetScript("OnValueChanged", function()
  TOCA.FrameMain:SetScale(TOCA:MathRound(TOCA.Slider.Scale:GetValue(), 2))
  TOCA.FrameWeap:SetScale(TOCA:MathRound(TOCA.Slider.Scale:GetValue(), 2))
	for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
		TOCA.FrameSeg[totemCat]:SetScale(TOCA:MathRound(TOCA.Slider.Scale:GetValue(), 2))
	end
  TOCA.Slider.Scale.Val:SetText(TOCA:MathRound(TOCA.Slider.Scale:GetValue(), 2))
end)
...
TOCA.Slider.Scale:SetScript("OnLeave", function()
  TOCADB[TOCA.player.combine]["CONFIG"]["SCALE"] = TOCA:MathRound(TOCA.Slider.Scale:GetValue(), 2)
  TOCA.CloseAllMenus()
end)
...
TOCA.Button.ResetPositionText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.FrameOptions.Title.OpacityBG:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Slider.OpacityBG.Val:SetFont(TOCA._G.font.style, TOCA._G.font.size-1, "OUTLINE")
...
TOCA.Slider.OpacityBG:SetScript("OnValueChanged", function()
  TOCA.FrameMain.Background:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  TOCA.FrameWeap.Background:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  --TOCA.Button.CloseMain:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  TOCA.Button.Options:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  TOCA.Button.TotemicCall.ECL:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  TOCA.Button.TotemicCall.ECR:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
  TOCA.Slider.OpacityBG.Val:SetText(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
	for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
		TOCA.FrameSeg[totemCat].Background:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2))
	end
end)
...
TOCA.Slider.OpacityBG:SetScript("OnLeave", function()
  TOCADB[TOCA.player.combine]["CONFIG"]["OPACITY"] = TOCA:MathRound(TOCA.Slider.OpacityBG:GetValue(), 2)
  TOCA.CloseAllMenus()
end)
...
TOCA.FrameOptions.Title.OpacityFG:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Slider.OpacityFG.Val:SetFont(TOCA._G.font.style, TOCA._G.font.size-1, "OUTLINE")
...
TOCA.Slider.OpacityFG:SetScript("OnValueChanged", function()
  for totemCat,v in TOCA:PairByKeys(TOCA.totems) do
    TOCA.SlotSelect[totemCat]:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
    TOCA.Slot[totemCat]:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
    TOCA.Button.DropdownMain:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
    for i,totemSpell in pairs(TOCA.totems[totemCat]) do
      TOCA.SlotGrid.VerticalTotemButton[totemCat][i]:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
      TOCA.SlotGrid.HorizontalTotemButton[totemCat][i]:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
			TOCA.FrameSeg.Button[totemCat][i]:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
    end
		TOCA.FrameMain.ShieldFrame:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
    TOCA.FrameMain.ReincFrame:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
		TOCA.FrameMain.AnkhFrame:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
  end
  TOCA.Button.CloseMain:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
  TOCA.Button.Options:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
  TOCA.Button.TotemicCall:SetAlpha(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
  TOCA.Slider.OpacityFG.Val:SetText(TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2))
end)
...
TOCA.Slider.OpacityFG:SetScript("OnLeave", function()
  TOCADB[TOCA.player.combine]["CONFIG"]["OPACITYFG"] = TOCA:MathRound(TOCA.Slider.OpacityFG:GetValue(), 2)
  TOCA.CloseAllMenus()
end)
...
TOCA.FrameOptions.Title.Menu:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Checkbox.MainLock.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.MainMenu.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.MainMenuOpt.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.Checkbox.MainMenuOpt.text:SetPoint("TOPLEFT", 25, -6)
TOCA.Checkbox.MainMenuOpt.text:SetText(TOCA._L.UI.FRAME[6][1])
TOCA.Checkbox.MainMenuOpt:SetScript("OnClick", function(self)
  if (self:GetChecked()) then
    TOCADB[TOCA.player.combine]["CONFIG"]["MAINMENUOPT"] = "ON"
    TOCA.Button.Options:Show()
  else
    TOCADB[TOCA.player.combine]["CONFIG"]["MAINMENUOPT"] = "OFF"
    TOCA.Button.Options:Hide()
    TOCA.Notification(TOCA._L.UI.FRAME[2][3])
  end
end)
TOCA.Checkbox.MainMenuOpt:SetScript("OnEnter", function(self)
  TOCA.TooltipDisplay(self, self.text:GetText(), TOCA._L.UI.FRAME[6][2])
end)
TOCA.Checkbox.MainMenuOpt:SetScript("OnLeave", function(self)
  TOCA.CloseAllMenus()
end)
...
TOCA.Checkbox.FrameBorder.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.Totemic.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.EndCaps.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Dropdown.FrameGryphons.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.FrameOptions.Title.Timer:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Checkbox.Timers.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.TimersInMinutes.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.Reinc.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.AuraShield.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.Checkbox.Ankh.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.FrameOptions.Title.Tooltip:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Checkbox.Tooltip.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.SlotOrderTitle:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
for i=1, getn(TOCA.Dropdown.OrderSetMenu) do
  ...
  TOCA.Dropdown.OrderSet[i].text:SetFont(TOCA._G.font.style, TOCA._G.font.size-2)
...
TOCA.FrameOptions.Title.Footer:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
TOCA.FrameOptions.Title.Footer:SetPoint("TOPLEFT", 10, -TOCA.FrameOptions_h+25)
TOCA.FrameOptions.Title.Footer:SetText(TOCA._G.title .. " " .. TOCA.Addon)
...
TOCA.Button.OptionsCloseText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.FrameOptionsMain.footer:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
TOCA.FrameOptionsMain.footer:SetPoint("TOPLEFT", 20, -40)
TOCA.FrameOptionsMain.footer:SetText(TOCA._G.title .. " " .. TOCA.Addon)

TOCA.FrameOptionsMain.text = TOCA.FrameOptionsMain.Options:CreateFontString(nil, "ARTWORK")
TOCA.FrameOptionsMain.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
Settings.TOCA.Button.OptionsOpenText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
