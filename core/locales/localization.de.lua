...
TOCA._L = {
  TITLE = "Totem-Caddy",
	...
	KEYBINDS = {
		TOTEM_RECALL    = "Totemischer Ruf",
		TOTEM_AIR       = "Totem Slot: Luft",
		TOTEM_EARTH     = "Totem Slot: Erde",
		TOTEM_FIRE      = "Totem Slot: Feuer",
		TOTEM_WATER     = "Totem Slot: Wasser",
  ...
  UI = {
		FRAMESTYLES = {"Klassisch", "Segmentiert", "Raster vertikal", "Gitter horizontal"},
		BUTTON = {"Nah dran", "Speichern", "Löschen", "ja", "Nein"},

		TABS = {
		  OPTIONS= {"Rahmen", "Sets", "Warnungen", "Weapons", "Minikarte", "Zuordnungen", "Klaviatur"},
		  HELP   = {"Aktualisierung", "Help", "Kontakt", "Kredit"}
		},
