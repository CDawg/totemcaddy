...
TOCA._L = {
  TITLE = "Totem Caddy",
	...
	KEYBINDS = {
		TOTEM_RECALL    = "Chamada Totêmica",
		TOTEM_AIR       = "Ranhura do Totem: Ar",
		TOTEM_EARTH     = "Espaço do Totem: Terra",
		TOTEM_FIRE      = "Espaço do Totem: Fogo",
		TOTEM_WATER     = "Ranhura do Totem: Água",
		SHIELD_WATER    = "Escudo: Água",
		SHIELD_LIGHTNING= "Escudo: Relâmpago",
		SHIELD_EARTH    = "Escudo: Terra",
  ...
  UI = {
		FRAMESTYLES = {"Clássico", "Segmentado", "Grade Vertical", "Grade Horizontal"},
		BUTTON = {"Fechar", "Salve", "Excluir", "sim", "Não"},

		TABS = {
		  OPTIONS= {"Quadro", "Conjuntos", "Notificações", "Weapons", "Minimapa", "Atribuições", "Teclado"},
		  HELP   = {"Atualizações", "Help", "Contato", "Crédito"}
		},
