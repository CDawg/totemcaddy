...
TOCA._L = {
  ...
  UI = {
		FRAMESTYLES = {"Clásico", "Segmentario", "Cuadrícula vertical", "Rejilla horizontal"},
		BUTTON = {"Cerca", "Ahorrar", "Borrar", "sí", "No"},

		TABS = {
		  OPTIONS= {"Marco", "Orden de tótem", "Notificaciones", "Weapons", "Minimapa", "Tareas", "Teclado"},
		  HELP   = {"Actualizaciones", "Help", "Contactos", "Crédito"}
		},
