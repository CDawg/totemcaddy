...
TOCA.Button.KeyBind={}
for i=1, 5 do
	TOCA.Button.KeyBind[i] = CreateFrame("Button", nil, TOCA.FrameOptionsPage[TOCA.locale.UI.TABS.OPTIONS[5]], "BackdropTemplate")
	...
	TOCA.Button.KeyBind[i].Title = TOCA.FrameOptionsPage[TOCA.locale.UI.TABS.OPTIONS[5]]:CreateFontString(nil, "ARTWORK")
