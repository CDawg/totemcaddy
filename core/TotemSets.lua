...
TOCA.FrameSets = CreateFrame("Button", TOCA.FrameSets, TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS], "BackdropTemplate")
...
TOCA.Button.FrameSetsSaveText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Button.FrameSetsDeleteOpenPrompt:SetScript("OnClick", function()
  ...
  if (profileSaveText == TOCA.Dropdown.Menu[1]) then
    ...
    --TOCA.FrameSets:Hide()
    TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS]:SetAlpha(0.50)
  end
end)
TOCA.Button.FrameSetsDeleteOpenPromptText = TOCA.Button.FrameSetsDeleteOpenPrompt:CreateFontString(nil, "ARTWORK")
TOCA.Button.FrameSetsDeleteOpenPromptText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Prompt.DeleteSetText:SetFont(TOCA._G.font.style, 14, "OUTLINE")
...
TOCA.Button.FrameSetsDelete:SetScript("OnClick", function()
  ...
  if (profileSaveText == TOCA.Dropdown.Menu[1]) then
    ...
    if (TOCADB[TOCA.player.combine]["PROFILES"][profileSaveText]) then
      ...
      TOCA.Prompt.DeleteSet:Hide()
      TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS]:SetAlpha(1)
    end
  end
  TOCA.CloseAllMenus()
end)
TOCA.Button.FrameSetsDeleteText = TOCA.Button.FrameSetsDelete:CreateFontString(nil, "ARTWORK")
TOCA.Button.FrameSetsDeleteText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.Button.FrameSetsCancelText:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
...
TOCA.FrameSetsProfileTitle = TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS]:CreateFontString(nil, "ARTWORK")
TOCA.FrameSetsProfileTitle:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.FrameSetsProfile:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.DropdownTitle = TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS]:CreateFontString(nil, "ARTWORK")
TOCA.DropdownTitle:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Dropdown.Sets = CreateFrame("Frame", nil, TOCA.FrameOptionsPage[TOCA.TABPage.TOTEMSETS], "UIDropDownMenuTemplate")
...
TOCA.Dropdown.Sets.text:SetFont(TOCA._G.font.style, TOCA._G.font.size-1)
