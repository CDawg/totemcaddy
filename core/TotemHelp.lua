...
for i=1, getn(TOCA._L.UI.TABS.HELP) do
  ...
  TOCA.Button.Tab[i].text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.FrameHelp.Header:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.TextFrameScrollFrame.Child:SetPoint("TOPLEFT", TOCA.TextFrameScrollFrame, "TOPLEFT", 5, -10)
TOCA.TextFrameScrollFrame.Child:SetPoint("BOTTOMRIGHT", TOCA.TextFrameScrollFrame, "BOTTOMRIGHT", 10, 10)
...
TOCA.TextFrameScrollFrame.Child.ScrollBar:SetPoint("TOPLEFT", TOCA.TextFrameScrollFrame.Child, "TOPRIGHT", -32, -17)
TOCA.TextFrameScrollFrame.Child.ScrollBar:SetPoint("BOTTOMRIGHT", TOCA.TextFrameScrollFrame.Child, "BOTTOMRIGHT", -11, 14)
...
TOCA.TextFrame.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, TOCA._G.font.flag)
...
TOCA.Button.CloseFrameHelp.text:SetFont(TOCA._G.font.style, TOCA._G.font.size, "OUTLINE")
...
TOCA.ShowAgain:SetFont(TOCA._G.font.style, TOCA._G.font.size-2, "OUTLINE")
...
TOCA:TableMerge(TOCA._L.INTRO[4], TOCA.VERSE)
